...
| **Multi-week booklet** | "Year 10 Electronics & Arduino" — 6 weeks x 4 lessons, cover page, contents, glossary |
...
├── build-pptx.js               -- PPTX slide deck build pipeline
├── common-pptx.js              -- PPTX shared formatting & helpers
├── resource.config.json        -- Edit per resource (title, creator, filename, header, contentDir)
├── content/                    -- One subfolder per resource
│   ├── electricity-unit-guide/
│   │   ├── 01-cover.js
│   │   └── 10-unit-guide.js
...
├── DOCX_BUILDER_REFERENCE.md   -- Full DOCX technical reference
├── PPTX_BUILDER_REFERENCE.md   -- Full PPTX technical reference
├── interview.html              -- Web-based questionnaire (standalone HTML)
├── package.json
...
- **[`pptxgenjs`](https://www.npmjs.com/package/pptxgenjs)** — Pure JavaScript .pptx generator for PowerPoint slide decks.
